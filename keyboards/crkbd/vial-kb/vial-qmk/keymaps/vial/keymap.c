...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,--------------------------------------------------------------.  ,--------------------------------------------------------------.
       KC_1,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T, KC_5,    KC_7,    KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  KC_BSPC,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
      KC_2,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G, KC_6,    KC_8,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,
  //|--------+--------+--------+--------+--------+--------+--------'  `--------+--------+--------+--------+--------+--------+--------|
      KC_3,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_0,
  //|--------+--------+--------+--------+--------+--------+--------.  ,--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, KC_4,  KC_SPC,     KC_ENT, KC_9, KC_RGUI
                                      //`--------------------------'  `--------------------------'
